                                ...
                                if($selExmne->rowCount() > 0)
                                {
                                    while ($selExmneRow = $selExmne->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                           ...
                                           <td>
                                               <a rel="facebox" href="facebox_modal/updateExaminee.php?id=<?php echo $selExmneRow['exmne_id']; ?>" class="btn btn-sm btn-primary">Update</a><button type="button" id="deleteExmne" data-id='<?php echo $selExmneRow['exmne_id']; ?>'  class="btn btn-danger btn-sm">Delete</button>
